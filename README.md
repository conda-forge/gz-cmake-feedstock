...
Once the `conda-forge` channel has been enabled, `gz-cmake, libgz-cmake` can be installed with `conda`:

```
conda install gz-cmake libgz-cmake
```

or with `mamba`:

```
mamba install gz-cmake libgz-cmake
```
